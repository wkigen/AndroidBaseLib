 ...
 *
 * @param <M> bean
 * @author Ricky Yao https://github.com/vihuela/RecyclerViewHelper
 */
public abstract class AdapterViewAdapter<M> extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        setItemCheckChangeListener(viewHolder.getViewHolderHelper());
     ...
     * @param viewHolderHelper
     */
    protected void setItemCheckChangeListener(ViewHolderHelper viewHolderHelper) {
    }
